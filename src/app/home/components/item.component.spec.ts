...
import { ToDoEffects } from '../store/product.effects';
import { ToDoHttpService } from '../store/product.httpservice';
import ToDoState, { initializeState } from '../store/product.state';
import { ToDoComponent } from './item.component';
...
describe('ToDoComponent', () => {
  ...
  it('To Do component show Error if there is error', () => {
    ...
    store.setState({
      todos: { Products: [firstWish], ToDoError: new Error('Test Error') }
    });
    store.refreshState();
